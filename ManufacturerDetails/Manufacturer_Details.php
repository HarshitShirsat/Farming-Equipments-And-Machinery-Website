...
$select_query = "SELECT Manufacturer_ID, Manufacturer_Name,Contact_No,Location_Of_Production FROM manufacturer_details";
...
<div class="green">
    ...
    <h1 style="text-align: center">MANUFACTURER DETAILS</h1>
    <form>
        <input class="form-control" id="myInput" type="text" placeholder="Search..">
    </form>

    <?php echo "<table id='Manuf_Table' class=\"table table-dark table-hover\"><thead><tr><th>Manufacturer ID</th><th>Manufacturer Name</th><th>Contact No.</th><th>Location of Production</th></tr></thead><tbody>"; ?>
    <?php while ($row = mysqli_fetch_array($select_query_result))
    { ?>
        <?php echo "<thread>"."<tr><td>". $row["Manufacturer_ID"]. "</td><td>". $row["Manufacturer_Name"]. "</td><td>". $row["Contact_No"]. "</td><td>".$row["Location_Of_Production"]. "</td></tr>". "</thread>"; ?>
