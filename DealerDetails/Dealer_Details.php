...
$select_query = "SELECT Dealer_ID, Dealer_Name,Contact_No, Location_Of_Store FROM dealer_details";
...
<div class="green ">
    ...
    <h1 style="text-align: center">DEALER DETAILS</h1>
    ...
    <?php echo "<table id='Deal_Table' class=\"table table-dark table-hover \"><thead><tr><th>Dealer ID</th><th>Dealer Name</th><th>Contact No.</th><th>Address</th></tr></thead><tbody>"; ?>
    <?php while ($row = mysqli_fetch_array($select_query_result))
    { ?>
        <?php echo "<thread>"."<tr><td>". $row["Dealer_ID"]. "</td><td>". $row["Dealer_Name"]. "</td><td>". $row["Contact_No"]. "</td><td>".$row["Location_Of_Store"]. "</td></tr>". "</thread>"; ?>
